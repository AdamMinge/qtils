...
#ifndef QTILS_PROPERTY_BROWSER_VARIANT_PROPERTY_H
#define QTILS_PROPERTY_BROWSER_VARIANT_PROPERTY_H

/* ------------------------------------ Qt ---------------------------------- */
#include <QtCore/QVariant>
#include <QtGui/QIcon>
/* ----------------------------------- Local -------------------------------- */
#include "qtils/property_browser/property_browser.h"
/* -------------------------------------------------------------------------- */
...
Q_DECLARE_METATYPE(qtils::QtIconMap)
#endif
