...
Q_DECLARE_METATYPE(qtils::QtEnumPropertyType)
Q_DECLARE_METATYPE(qtils::QtFlagPropertyType)
Q_DECLARE_METATYPE(qtils::QtGroupPropertyType)
...
#include "qtils/property_browser/moc_variant_property.cpp"
